...
public class loadOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from orderlogs where orderstatus !='Finished'");
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                orderInfo object = new orderInfo();
                object.setOrderid(rs.getInt("orderid"));
                object.setOrderstatus(rs.getString("orderstatus"));
                object.setPhoneno(rs.getString("phoneno"));
                object.setAmount(rs.getDouble("amount"));
                orderInfo.setList(object);
            }
